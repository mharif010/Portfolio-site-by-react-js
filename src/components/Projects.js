...
import Project1 from './mockup/netcom.jpg'
import Project2 from './mockup/transfotech.jpg'
import Project3 from './mockup/psny.jpg'
import Project4 from './mockup/birdland.jpg'
import Project5 from './mockup/dnd.jpg'
import Project6 from './mockup/netcom.jpg'
import Project7 from './mockup/civil.jpg'
  ...
  <div class="container">
    ...
    <div class="nav-tabs-wrapper">
      <ul class="nav nav-tabs" id="tabs-title-region-nav-tabs" role="tablist">
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" role="tab" href="#block-simple-text-1" aria-selected="false" aria-controls="block-simple-text-1" id="block-simple-text-1-tab">First tab</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" role="tab" href="#block-simple-text-2" aria-selected="false" aria-controls="block-simple-text-2" id="block-simple-text-2-tab">How do we use it?</a>
        </li>
        <li class="nav-item">
    ...
    <h2 class="section-title mb-2 h1">Completed Projects</h2>
        <p class="text-center text-muted h5 mb-5">Having and managing a correct marketing strategy is crucial in a fast moving market.</p>
      <div className="row">
        <div className="col-md-4 col-sm-6 col-6 mb-5">
          <div className="project-box">
            <a href="http://netcomconstructioninc.com" target="_blank">
              <img src={Project1} ></img>
            </a>
            <div>
            <a href="http://netcomconstructioninc.com" target="_blank">NetCom Live</a>
              <p>Lorem ipsum dollar sumit</p>
            </div>
        ...
        <div className="col-md-4 col-sm-6 col-6 mb-5">
          <div className="project-box">
            ...
            <div>
            <a href="http://netcomconstructioninc.com" target="_blank">Transfo Tech</a>
              <p>Custom Wordpress Educational Site</p>
            </div>
